...
public class CustomerView implements Observer {
    ...
    public CustomerView(String title) {
        ...
        Scene scene = new Scene(root, 400, 350); // Increased height to accommodate progress bar
    ...
    @Override
    public void update(String currentProgressText, List<String> customerQueue, int currentStep) {
        Platform.runLater(() -> { 
            ...
            if (customerQueue.isEmpty()) {
                ...
                for (String customerName : customerQueue) {
                    // mapping customer names to unique colors
                    int colorIndex = Math.abs(customerName.hashCode()) % customerBoxColors.length;
